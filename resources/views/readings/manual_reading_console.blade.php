                ...
                <div class="row">
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" step="any"  name="DeductedDeposit" id="DeductedDeposit" class="form-control form-control-sm text-right" readonly="true">
                            </td>
                            <td>
                                <label for="ExcessDeposit">Pre-Payment Balance</label>
                            </td>
                            <td>
                                <input type="text" step="any"  name="ExcessDeposit" id="ExcessDeposit" class="form-control form-control-sm text-right" readonly="true">
                            </td>
                        </tr>
                    </table>
                </div>
