...
Route::get('/paid_bills/third-party-collection-dcr/{source}/{date}/{series}/{postingDate}', [App\Http\Controllers\PaidBillsController::class, 'thirdPartyCollectionDCR'])->name('paidBills.third-party-collection-dcr');
Route::get('/paid_bills/clear-all-tcp-uploads', [App\Http\Controllers\PaidBillsController::class, 'clearAllTcpUploads'])->name('paidBills.clear-all-tcp-uploads');
Route::get('/paid_bills/cancel-or-admin', [App\Http\Controllers\PaidBillsController::class, 'cancelORAdmin'])->name('paidBills.cancel-or-admin');
Route::get('/paid_bills/collection-summary-report', [App\Http\Controllers\PaidBillsController::class, 'collectionSummaryReport'])->name('paidBills.collection-summary-report');
Route::get('/paid_bills/print-collection-summary-report/{from}/{to}/{town}', [App\Http\Controllers\PaidBillsController::class, 'printCollectionSummaryReport'])->name('paidBills.print-collection-summary-report');
Route::get('/paid_bills/aging-report', [App\Http\Controllers\PaidBillsController::class, 'agingReport'])->name('paidBills.aging-report');
Route::get('/paid_bills/print-aging-report/{town}/{asOf}', [App\Http\Controllers\PaidBillsController::class, 'printAgingReport'])->name('paidBills.print-aging-report');
Route::get('/paid_bills/third-party-report', [App\Http\Controllers\PaidBillsController::class, 'thirdPartyReport'])->name('paidBills.third-party-report');
Route::get('/paid_bills/print-third-party-report/{day}/{town}', [App\Http\Controllers\PaidBillsController::class, 'printThirdPartyReport'])->name('paidBills.print-third-party-report');
Route::get('/paid_bills/third-party-api-console', [App\Http\Controllers\PaidBillsController::class, 'thirdPartyAPIConsole'])->name('paidBills.third-party-api-console');
Route::get('/paid_bills/third-party-collection-api-dcr/{source}/{date}', [App\Http\Controllers\PaidBillsController::class, 'thirdPartyCollectionAPIDCR'])->name('paidBills.third-party-collection-api-dcr');
Route::get('/paid_bills/clear-deposit', [App\Http\Controllers\PaidBillsController::class, 'clearDeposit'])->name('paidBills.clear-deposit');
Route::get('/paid_bills/fix-third-party-dcr', [App\Http\Controllers\PaidBillsController::class, 'fixThirdPartyDCR'])->name('paidBills.fix-third-party-dcr');
